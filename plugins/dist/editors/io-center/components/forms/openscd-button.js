...
let OpenscdButton = class OpenscdButton extends LitElement {
    constructor() {
        super(...arguments);
        this.label = "";
        this.icon = "";
...
], OpenscdButton.prototype, "label", void 0);
__decorate([
    property({ type: String })
], OpenscdButton.prototype, "icon", void 0);
__decorate([
    property({ type: String })
], OpenscdButton.prototype, "variant", void 0);
__decorate([
    property({ type: Boolean })
], OpenscdButton.prototype, "disabled", void 0);
OpenscdButton = __decorate([
    customElement("openscd-button")
], OpenscdButton);
export { OpenscdButton };
//# sourceMappingURL=openscd-button.js.map