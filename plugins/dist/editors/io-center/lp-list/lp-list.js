...
let LpList = class LpList extends IoCenterFoundation {
    constructor() {
        super();
        this.searchTerm = '';
...
], LpList.prototype, "searchTerm", void 0);
__decorate([
    state()
], LpList.prototype, "selectedItems", void 0);
__decorate([
    state()
], LpList.prototype, "lpItems", void 0);
LpList = __decorate([
    customElement('lp-list')
], LpList);
export { LpList };
//# sourceMappingURL=lp-list.js.map