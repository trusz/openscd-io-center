...
export let RouterSelection = class extends LitElement {
  constructor() {
    super(...arguments);
...
], RouterSelection.prototype, "multiSelect", 2);
__decorate([
  property({type: String})
], RouterSelection.prototype, "label", 2);
__decorate([
  property({type: String})
], RouterSelection.prototype, "noItemsText", 2);
__decorate([
  state()
], RouterSelection.prototype, "items", 2);
__decorate([
  state()
], RouterSelection.prototype, "isLrtiSelected", 2);
__decorate([
  state()
], RouterSelection.prototype, "selectedRouter", 2);
__decorate([
  state()
], RouterSelection.prototype, "lrtiInputs", 2);
__decorate([
  state()
], RouterSelection.prototype, "isFormValid", 2);
__decorate([
  state()
], RouterSelection.prototype, "routerInstance", 2);
