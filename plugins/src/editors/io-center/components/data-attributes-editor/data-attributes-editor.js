...
export let DataAttributesEditor = class extends LitElement {
  constructor() {
    super(...arguments);
    this.doc = void 0;
    this.lnClass = "";
  ...
  _onSearchChange(event) {
    ...
    this.filteredDataObjects = allDataObjects.filter((doObj) => doObj.name?.toLowerCase().includes(searchValue) || doObj.dataAttributes.some((da) => da.name?.toLowerCase().includes(searchValue) || da.fc?.toLowerCase().includes(searchValue) || da.bType?.toLowerCase().includes(searchValue)));
  }
  ...
  render() {
    ...
    const displayedDataObjects = this.showOnlyModified ? dataObjects.filter((doObj) => Object.keys(this.attributeValues[doObj.name] || {}).length > 0) : dataObjects;
...
], DataAttributesEditor.prototype, "doc", 2);
__decorate([
  property({type: String})
], DataAttributesEditor.prototype, "lnClass", 2);
__decorate([
  property({type: Object})
], DataAttributesEditor.prototype, "formGroup", 2);
__decorate([
  property({type: Array})
], DataAttributesEditor.prototype, "filteredDataObjects", 2);
__decorate([
  property({type: Boolean})
], DataAttributesEditor.prototype, "showOnlyModified", 2);
