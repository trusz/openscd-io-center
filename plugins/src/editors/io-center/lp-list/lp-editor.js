...
export let LpEditor = class extends LitElement {
  constructor() {
    super();
...
__decorate([
  query("form-group")
], LpEditor.prototype, "formGroup", 2);
__decorate([
  query("data-attributes-editor")
], LpEditor.prototype, "dataAttributesEditor", 2);
__decorate([
  property({type: Boolean})
], LpEditor.prototype, "showModal", 2);
__decorate([
  property({type: Object})
], LpEditor.prototype, "doc", 2);
__decorate([
  state()
], LpEditor.prototype, "isFormValid", 2);
__decorate([
  state()
], LpEditor.prototype, "lpName", 2);
__decorate([
  state()
], LpEditor.prototype, "lpDesc", 2);
__decorate([
  state()
], LpEditor.prototype, "lpType", 2);
__decorate([
  state()
], LpEditor.prototype, "lpInst", 2);
__decorate([
  state()
], LpEditor.prototype, "attributeValues", 2);
LpEditor = __decorate([
